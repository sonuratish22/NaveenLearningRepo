...
public class ElementUtil  {
    ...
    public String waitForTitleContains(Duration timeOut, String titleFraction) {
        WebDriverWait wait = new WebDriverWait(driver, timeOut);
    ...
    public String waitForTitleToBe(Duration timeOut, String title) {
        WebDriverWait wait = new WebDriverWait(driver, timeOut);
    ...
    public void waitForFrameUsingByLocator(By frameLocator, Duration timeOut) {
        WebDriverWait wait = new WebDriverWait(driver, timeOut);
        wait.until(ExpectedConditions.frameToBeAvailableAndSwitchToIt(frameLocator));
    }

    public void waitForFrameUsingWebElement(WebElement frameElement, Duration timeOut) {
        WebDriverWait wait = new WebDriverWait(driver, timeOut);
        wait.until(ExpectedConditions.frameToBeAvailableAndSwitchToIt(frameElement));
    }

    public List<WebElement> waitForElementsPresence(By locator, Duration timeOut) {
        WebDriverWait wait = new WebDriverWait(driver, timeOut);
    ...
    public List<String> getVisibleElementsTextList(By locator, Duration timeOut) {
    ...
    public WebElement waitForElementPresent(By locator, Duration timeOut, Duration intervalTime) {
    ...
    public WebElement waitForElementPresenceWithWebDriverWait(By locator, Duration timeOut, int pollingTime) {
        WebDriverWait wait = new WebDriverWait(driver, timeOut);
